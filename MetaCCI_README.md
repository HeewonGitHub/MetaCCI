...
The MetaCCI pipeline consists of the following steps:
...
Extract regulator--target relationships.
...
CCI inference is performed using **eigen-cell representation** and
**correlation-based interaction testing**.

### Required Input

    MetaCCI_DATA/NW_Q.csv
    MetaCCI_DATA/NW_C.csv
    MetaCCI_DATA/mEXP.txt
    MetaCCI_DATA/drGENEs.txt
    MetaCCI_DATA/T_OBS300.txt

### Core Procedure

1.  Identify **differentially regulated genes**
2.  Compute **gene activity scores**
3.  Estimate **eigen cells using PCA**
4.  Infer **cell--cell interactions using correlation networks**
5.  Evaluate statistical significance using **hypergeometric tests**
...
All scripts and example datasets are provided in this repository to
ensure **full reproducibility of the MetaCCI pipeline**.

Researchers can apply the workflow to **user-provided gene expression
datasets** by replacing the input files with their own data.

------------------------------------------------------------------------

## Citation

If you use this software in your research, please cite the MetaCCI
paper.
